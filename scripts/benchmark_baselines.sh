...
# --config-list: the block size is only a label in --skip-launch-server mode.
# 'auto' marks "speculating, the config lives on the server side"; the actual
# algorithm is in ${NAME}. Use 64,0 for a no-speculation run.
